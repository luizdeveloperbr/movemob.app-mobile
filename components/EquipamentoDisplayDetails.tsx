...
const EquipamentoDisplayDetalComponent = ({ getInfoProp, showSpinner }: { getInfoProp: EquipamentoDetailsType | undefined, showSpinner: boolean }) => {
  return (
